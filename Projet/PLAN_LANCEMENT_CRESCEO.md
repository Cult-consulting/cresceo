...
|--------|----------|-------------|-------------|--------|
| Acheter **cresceo.fr** | CRITIQUE | ~12€/an | Baptiste | **FAIT** |
| ~~Acheter cresceo.com~~ | ~~HAUTE~~ | - | - | **Non disponible** |
| Optionnel : cresceo.eu | BASSE | ~10€/an | - | À évaluer |

*Note : cresceo.fr acheté par Baptiste. cresceo.com non disponible — le .fr est suffisant pour le marché France.*
...
- [ ] Préparer pipe CAD42 avec Igor
- [ ] Cartographie cibles : PME BTP, OPC/MOEx, intérimaires
...
| **Total** | **~2 700€** | Échelonné Phase 1 / Phase 2 |

*Note : Le devis EBCI (2 500€ HT / 3 000€ TTC) couvre un périmètre beaucoup plus large que le logo seul : identité visuelle complète, maquette site web, vidéo, templates, gestion réseaux sociaux année 1, stratégie de lancement. Paiement échelonné.*
